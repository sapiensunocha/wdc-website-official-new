...
const STATIC_POSTS = [
  ...
  { id: "lst-senegal", type: "photo", category: "Field Reports",
    ...
    link: "https://www.linkedin.com/company/worlddisastercenter" },
  { id: "video-michael-intro", type: "video", category: "Videos",
    title: "Michael — WDC's Disaster Intelligence System",
    body: "Introduction to Michael, World Disaster Center's AI-powered disaster intelligence platform delivering real-time early warnings, field mission coordination, and multi-hazard monitoring across 40+ countries.",
    image: null, tags: ["Michael", "Platform", "AI", "Early Warning"], date: "2024", likes: 63,
    youtubeEmbed: "https://www.youtube.com/embed/CqSbBNh41o0?autoplay=1&mute=1&rel=0",
    link: "https://www.youtube.com/watch?v=CqSbBNh41o0" },
  ...
  { id: "video-michael-v2", type: "video", category: "Videos",
    title: "Michael v2.0 is Out! — New Features & Capabilities",
    body: "Michael v2.0 brings enhanced disaster monitoring capabilities, improved AI predictions, and expanded coverage. See the new features powering WDC's field operations worldwide.",
    image: null, tags: ["Michael", "v2.0", "Platform", "Update"], date: "2024", likes: 44,
    youtubeEmbed: "https://www.youtube.com/embed/oxV6-k-Deuk?autoplay=1&mute=1&rel=0",
    link: "https://www.youtube.com/watch?v=oxV6-k-Deuk" },
  { id: "video-survive-crisis", type: "video", category: "Videos",
    title: "Survive the Crisis, Scale Your Impact — WDC",
    body: "WDC's message to humanitarian partners and communities: how to survive a crisis and scale your impact using disaster intelligence, community reporting, and AI-driven early warning systems.",
    image: null, tags: ["Crisis", "Impact", "Resilience", "Mission"], date: "2024", likes: 38,
    youtubeEmbed: "https://www.youtube.com/embed/LpWff64gN04?autoplay=1&mute=1&rel=0",
    link: "https://www.youtube.com/watch?v=LpWff64gN04" },
  { id: "video-save-our-world", type: "video", category: "Videos",
    title: "Together, We Can Save Our World — World Disaster Center",
    body: "A call to action from World Disaster Center: together, through technology, partnerships, and community resilience, we can reduce disaster impact and protect the world's most vulnerable communities.",
    image: null, tags: ["Mission", "Community", "Resilience", "Together"], date: "2024", likes: 71,
    youtubeEmbed: "https://www.youtube.com/embed/ubau40zLZC4?autoplay=1&mute=1&rel=0",
    link: "https://www.youtube.com/watch?v=ubau40zLZC4" },
