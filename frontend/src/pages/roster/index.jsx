...
export default function RosterPage() {
  ...
  return (
    <>
    <SEOMeta
      title="WDC Global Roster — Deploy World-Class Disaster Experts"
      description="The world's most rigorous humanitarian talent platform. 1,200+ certified experts, 68 countries, 48-hour matching. WDC handles contracts and compliance."
