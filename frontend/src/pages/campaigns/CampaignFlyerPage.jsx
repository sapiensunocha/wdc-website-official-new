    ...
    <>
      ...
      >
        ...
        <span style={{ fontWeight: 800, fontSize: 14, color: "#fff", flex: 1, textAlign: "center" }}>
          {c.emoji} {c.title} — Campaign Flyer
        </span>
        <button
        ...
        >
          ...
          <div
            style={{
              ...
              borderTop: `2px solid ${c.color}30`,
              borderBottom: `2px solid ${c.color}30`,
              padding: "12px 24px",
              display: "grid",
            ...
            {c.vulnerabilityStats.slice(0, 4).map((s, i) => (
              <div
                ...
                style={{
                  textAlign: "center",
                  padding: "0 8px",
                  borderRight: i < 3 ? `1px solid ${c.color}30` : "none",
                }}
              >
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 9, color: "#6b7280", marginTop: 2 }}>
                Donate:{" "}
                <span style={{ color: "#009EDB" }}>{PAYPAL_URL.replace("https://", "")}</span>
              </div>
