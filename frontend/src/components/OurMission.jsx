...
const ServiceCard = ({ icon, title, details, index }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
    >
      <div className="mb-9 rounded-[20px] min-h-[500px] bg-white p-10 shadow-sm hover:shadow-md md:px-7 xl:px-10 border border-gray-200 transition-shadow duration-300">
        <motion.div
